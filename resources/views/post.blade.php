        ...
        <div class="md:w-1/2 md:mx-auto">
            ...
            <div class="flex flex-col break-words bg-white border border-2 rounded shadow-md">
                ...
                <div class="w-full p-6">
                    ...
                    <p class="mt-6">
                        <textarea rows="5" id="title" class="shadow appearance-none w-full mx-auto border rounded py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline{{ $errors->has('content') ? 'border-red-500' : '' }}" placeholder="Content" name="title"required autofocus>{{ old('content') }}</textarea>
                    </p>
                    <p class="mt-6">
